...
function ve() {
  return Or || (Or = 1, process.env.NODE_ENV !== "production" && function() {
    var a = Z, n = Symbol.for("react.element"), u = Symbol.for("react.portal"), o = Symbol.for("react.fragment"), v = Symbol.for("react.strict_mode"), p = Symbol.for("react.profiler"), g = Symbol.for("react.provider"), b = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), R = Symbol.for("react.suspense"), h = Symbol.for("react.suspense_list"), O = Symbol.for("react.memo"), P = Symbol.for("react.lazy"), I = Symbol.for("react.offscreen"), Q = Symbol.iterator, Ar = "@@iterator";
    function kr(r) {
    ...
    var Vr = !1, Ir = !1, Nr = !1, $r = !1, Wr = !1, rr;
    rr = Symbol.for("react.module.reference");
    function Yr(r) {
      return !!(typeof r == "string" || typeof r == "function" || r === o || r === p || Wr || r === v || r === R || r === h || $r || r === I || Vr || Ir || Nr || typeof r == "object" && r !== null && (r.$$typeof === P || r.$$typeof === O || r.$$typeof === g || r.$$typeof === b || r.$$typeof === c || // This needs to include all possible module reference object
    ...
    var w = Object.assign, A = 0, tr, ar, nr, or, ir, ur, sr;
    function fr() {
    }
...
` + s[y].replace(" at new ", " at ");
                    return r.displayName && j.includes("<anonymous>") && (j = j.replace("<anonymous>", r.displayName)), typeof r == "function" && $.set(r, j), j;
                  }
                while (y >= 1 && m >= 0);
              break;
            }
      ...
      return typeof r == "function" && $.set(r, jr), jr;
    }
    function qr(r, e, t) {
      return lr(r, !1);
    }
    ...
    function L(r) {
      if (r) {
        var e = r._owner, t = W(r.type, r._source, e ? e.type : null);
    ...
    function re(r, e) {
      if (typeof r.ref == "string" && k.current && e && k.current.stateNode !== e) {
        ...
        J[t] || (_('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', x(k.current.type), r.ref), J[t] = !0);
      }
    }
    function ee(r, e) {
      {
    ...
    function ne(r, e, t, i, l) {
      {
        ...
        return ae(r, s, E, l, i, k.current, f);
      }
    }
    var G = C.ReactCurrentOwner, gr = C.ReactDebugCurrentFrame;
    function S(r) {
      if (r) {
        var e = r._owner, t = W(r.type, r._source, e ? e.type : null);
...
function pe() {
  ...
  function g(b, c, R) {
    ...
    if (b && b.defaultProps)
      for (h in c = b.defaultProps, c)
        O[h] === void 0 && (O[h] = c[h]);
    return { $$typeof: n, type: b, key: P, ref: I, props: O, _owner: v.current };
  }
  return V.Fragment = u, V.jsx = g, V.jsxs = g, V;
}
...
var be = (a, n, u) => {
  ...
  var n = (u) => {
    ...
    for (var p in v) {
      var g, b = (g = v[p]) !== null && g !== void 0 ? g : a.defaultVariants[p];
      if (b != null) {
        var c = b;
...
function Dr(a, n) {
  ...
  for (var v in a) {
    var p = a[v], g = [...u, v];
    typeof p == "string" || typeof p == "number" || p == null ? o[v] = n(p, g) : typeof p == "object" && !Array.isArray(p) ? o[v] = Dr(p, n, g) : console.warn('Skipping invalid key "'.concat(g.join("."), '". Should be a string, number, null or object. Received: "').concat(Array.isArray(p) ? "Array" : typeof p, '"'));
  }
  return o;
}
function je(a, n) {
...
var we = "vjg68i0";
const Ce = Z.createContext({}), Ae = ({ children: a }) => {
  const [n, u] = Sr("light"), o = n === "light", v = () => u(o ? "dark" : "light");
  return /* @__PURE__ */ M.jsx(Ce.Provider, { value: { themeMode: n, toggleTheme: v }, children: /* @__PURE__ */ M.jsx(
    "div",
    {
      className: `${o ? xe : Oe} ${we}`,
      style: je(Te, Pe),
      children: a
    }
  ) });
